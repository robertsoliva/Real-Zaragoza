...
[2026-06-26]||GCP infrastructure live: APIs enabled, rz_raw + rz_processed datasets created (europe-west1), rz_raw.transfermarkt_squad table created and loaded (32 rows), rz_processed.squad_snapshots view live, Pub/Sub topics rz-data-ingested + DLQ created, service account rz-pipeline created with minimum IAM roles, budget alert set at €10/month.
