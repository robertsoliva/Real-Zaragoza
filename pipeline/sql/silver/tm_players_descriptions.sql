ALTER TABLE `real-zaragoza-500608.silver.tm_players`
  ...
  ALTER COLUMN position SET OPTIONS(description="Transfermarkt position label — source of truth for scouting position classification"),
